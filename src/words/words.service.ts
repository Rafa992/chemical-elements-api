...
import { chemicalElementsStatic } from 'src/data/chemicalElements'
		...
		try {
			return await this.prisma.elements.update({
				...
				data: {
					...
					symbol: elementsData.symbol,
					name: elementsData.name,
					atomicMass: elementsData.atomicMass,
					group: elementsData.group,
					period: elementsData.period,
